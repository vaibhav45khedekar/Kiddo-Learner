...
IMAGE_DIR = r"D:/vvd/images/alphabet"
...
class AlphabetsApp:
    def __init__(self, root, main_menu, show_frame):
        ...
        self.root.title("Learn Alphabets")
       ...
       #self.root.geometry("450x650")
        ...
        self.app_title = create_title_label(root, "Alphabets")
        self.app_title.pack(fill='x')

        self.alphabet_label = tk.Label(
            root, text="", font=("Arial", 36, "bold"), 
            bg="#F4F6F6", fg="#BA2604"
        )
        self.alphabet_label.pack(pady=(20, 10))
        ...
        self.prev_btn = ttk.Button(nav_frame, text="⏮ Prev", command=self.prev_letter, style='Nav.TButton')
        self.prev_btn.grid(row=0, column=0, padx=40)

        self.next_btn = ttk.Button(nav_frame, text="Next ⏭", command=self.next_letter, style='Nav.TButton')
    ...
    def show_alphabet(self):
        letter = alphabets[self.index]
        self.alphabet_label.config(text=letter)
    ...
    def next_letter(self):
        self.index = (self.index + 1) % len(alphabets)
        self.show_alphabet()
    ...
    def speak_letter(self):
        ...
        try:
            ...
            current_letter = alphabets[self.index]
...
def run(parent_root, main_menu, show_frame):
    ...
    app = AlphabetsApp(toplevel, main_menu, show_frame)
